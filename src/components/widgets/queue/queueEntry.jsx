export default function QueueEntry({ title, activity, timeLeft, progress, size, speed, percentComplete }) {
  const details = [size, percentComplete, speed, activity, timeLeft].filter(Boolean);
